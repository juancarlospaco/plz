...
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19080614_;
extern NIM_BOOL nimInErrorMode__759bT87luu8XGcbkw13FUjA;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_19080637_;
extern tyProc__wCuLyuC5VitcgJKGCqJQRw Dl_19081026_;
extern tyProc__5zMKCPIiPHTYY9cjyzsHlmQ Dl_19081020_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_19066248_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_19080660_;
extern tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_19090414_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_19080648_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_19080669_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_19080673_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080678_;
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19090622_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080701_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_19080724_;
extern tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_19080619_;
extern int osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_19080616_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_19080697_;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080711_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080728_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_19080719_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080731_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_19080714_;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		if (!T3_) goto LA7_;
		T9_ = (long)0;
		T9_ = Dl_19090414_(ctx, ((int) 94), ((long) (onoff)), NIM_NIL);
		result = ((int) (T9_));
	}
	goto LA1_;
	LA7_: ;
...
appendString(T18_, keyFile);
	...
	LA15_: ;
	{
		...
		ret = Dl_19080669_(ctx, nimToCStringConv(certFile));
		{
	...
	LA21_: ;
	{
		if (!!(((keyFile ? keyFile->Sup.len : 0) == 0))) goto LA29_;
		{
			int T33_;
			T33_ = (int)0;
			T33_ = Dl_19080673_(ctx, nimToCStringConv(keyFile), ((int) 1));
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		int T9_;
		T9_ = (int)0;
		T9_ = Dl_19080660_(newCTX, nimToCStringConv(cipherList));
	...
	LA26_: ;
	Dl_19080648_(newCTX, ((NI) 0), NIM_NIL);
	{
...
{nimErr_ = nimErrorFlag();
	{
		if (!(*socket).isSsl) goto LA3_;
		{
			...
			ret = Dl_19080724_((*socket).sslHandle, ((int) (err)));
			switch (ret) {
			case ((NI) 6):
			{
...
appendString(errStr, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_22));
					...
					LA38_: ;
					{
						...
						NimStringDesc* T42_;
						T41_ = (NCSTRING)0;
						T41_ = Dl_19081020_(sslErr, NIM_NIL);
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T4_) goto LA6_;
		{
			...
			Dl_19090622_();
			res = Dl_19080701_((*socket).sslHandle);
			{
			...
			LA43_: ;
			{
				...
				sslError = Dl_19080724_((*socket).sslHandle, res);
				{
					NIM_BOOL T50_;
					T50_ = (NIM_BOOL)0;
...
{nimErr_ = nimErrorFlag();
	...
	(*socket).sslHandle = Dl_19080616_((*(*socket).sslContext).context);
	...
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_19080697_((*socket).sslHandle, (*socket).fd);
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 0):
	{
		...
		LA7_: ;
		Dl_19090622_();
		ret = Dl_19080711_((*socket).sslHandle);
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 1):
	{
		int ret_2;
		Dl_19090622_();
		ret_2 = Dl_19080728_((*socket).sslHandle);
...
{	result = (NI)0;
	{
		...
		Dl_19090622_();
		T5_ = (int)0;
		T5_ = Dl_19080719_((*socket).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
appendString(T24_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_40));
		...
		LA21_: ;
		{
			...
			LA32_: ;
			sslPending = Dl_19080731_((*socket).sslHandle);
			{
...
{	result = (NI)0;
	result = ((NI) 0);
	{
		...
		Dl_19090622_();
		T5_ = (int)0;
		T5_ = Dl_19080714_((*socket).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
