...
tyProc__9cfAa2qMwRsugQ9bZaJfhIcQ Dl_12797640_;
...
tyProc__As5z9bYt859cLKWaorPRgQYA Dl_12798442_;
tyProc__9aO2cP4IgwjXF8JfUR57CHQ Dl_12798260_;
tyProc__IQbFr9cLT9bipWCXYfwYwjOw Dl_12798265_;
tyProc__m8OtNuKklv1X2vQjXQkzSA Dl_12800067_;
tyProc__2Dt6vzy4xOVEtn3qjtrTDQ Dl_12797624_;
tyProc__dQrdVesp1gLEVufnwKAlGA Dl_12797650_;
...
tyProc__KHeEdNTR0xu6nVKzb2dFPw Dl_12797018_;
tyProc__lLim4ugM6CVjiaTaa7eXVA Dl_12797456_;
tyProc__ofoySXaAAlxxs9bQS9a1etlg Dl_12797614_;
tyProc__MvjKU9c5nvs0N3IrS4vNgSw Dl_12798447_;
tyProc__IV3cwg4tBg3JP8ITSKt7oQ Dl_12798456_;
tyProc__T129bsPZ4FvuSF4rGFSBKkg Dl_12798281_;
tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_12798345_;
tyProc__rWrG4X5lbcXQyLNkF9aNWhQ Dl_12798336_;
tyProc__8Py1tJvU9bm83KdBcpIBjeQ Dl_12798377_;
tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_12798320_;
...
tyProc__2Dt6vzy4xOVEtn3qjtrTDQ Dl_12797008_;
static void* TM__k6kyf4Co79a84IkK9blFuQVA_96;
tyProc__zKRRdAZhB37HYjlJgTxZRg Dl_12797867_;
...
if (!((TM__k6kyf4Co79a84IkK9blFuQVA_3 = nimLoadLibrary(((NimStringDesc*) &TM__k6kyf4Co79a84IkK9blFuQVA_5)))
	...
	Dl_12797640_ = (tyProc__9cfAa2qMwRsugQ9bZaJfhIcQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "MoveFileExW");
...
if (!((TM__k6kyf4Co79a84IkK9blFuQVA_19 = nimLoadLibrary(((NimStringDesc*) &TM__k6kyf4Co79a84IkK9blFuQVA_21)))
	...
	Dl_12798442_ = (tyProc__As5z9bYt859cLKWaorPRgQYA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "WSAStartup");
	Dl_12798260_ = (tyProc__9aO2cP4IgwjXF8JfUR57CHQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "socket");
	Dl_12798265_ = (tyProc__IQbFr9cLT9bipWCXYfwYwjOw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "closesocket");
	Dl_12800067_ = (tyProc__m8OtNuKklv1X2vQjXQkzSA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "WSAIoctl");
	Dl_12797624_ = (tyProc__2Dt6vzy4xOVEtn3qjtrTDQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "GetFileAttributesW");
	Dl_12797650_ = (tyProc__dQrdVesp1gLEVufnwKAlGA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "GetCommandLineW");
	...
	Dl_12797018_ = (tyProc__KHeEdNTR0xu6nVKzb2dFPw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "SetEnvironmentVariableW");
	...
	Dl_12798447_ = (tyProc__MvjKU9c5nvs0N3IrS4vNgSw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "getaddrinfo");
	Dl_12798456_ = (tyProc__IV3cwg4tBg3JP8ITSKt7oQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "freeaddrinfo");
	Dl_12798281_ = (tyProc__T129bsPZ4FvuSF4rGFSBKkg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "connect");
	Dl_12798345_ = (tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "send");
	Dl_12798336_ = (tyProc__rWrG4X5lbcXQyLNkF9aNWhQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "select");
	Dl_12798377_ = (tyProc__8Py1tJvU9bm83KdBcpIBjeQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "__WSAFDIsSet");
	Dl_12798320_ = (tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_19, "recv");
	...
	Dl_12797008_ = (tyProc__2Dt6vzy4xOVEtn3qjtrTDQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "SetCurrentDirectoryW");
if (!((TM__k6kyf4Co79a84IkK9blFuQVA_96 = nimLoadLibrary(((NimStringDesc*) &TM__k6kyf4Co79a84IkK9blFuQVA_98)))
	...
	Dl_12797867_ = (tyProc__zKRRdAZhB37HYjlJgTxZRg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_96, "ShellExecuteW");
}
