...
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "SSL_in_init", 11);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_50, "SSL_state", 9);
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_18930614_;
static void* TM__SLGpYVEqpFQ7VaPsJH6HIA_15;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_18930637_;
tyProc__HBcM2Mt9bfW9bP8CkO25r0mA Dl_18931026_;
tyProc__ILGNrKdZ6rU9bHuzDylmHhA Dl_18931020_;
tyProc__HXibadfWHwHwyhCwpIRD2A Dl_18915661_;
tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_18930660_;
...
tyProc__J5jVzoevP749cPcyUg9cwPEA Dl_18940414_;
tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_18930648_;
tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_18930669_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_18930673_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18930678_;
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_18940622_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18930701_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_18930724_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_18930619_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_18930616_;
tyProc__EJ9cbYwLVOng2t4wnewGkmA Dl_18930697_;
tyProc__xGcw2zK9bzuUE9c8WzKW5hzw Dl_18940443_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18930711_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18930728_;
tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_18930719_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18930731_;
tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_18930714_;
...
{nimErr_ = nimErrorFlag();
	result = (tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw*)0;
	result = loadPSSLMethod__Ly1cbhDPrPcypgHb7sj70w(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_26), ((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_27));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = (void*)0;
	T1_ = utilSymNullable__dsinlRPqANpoUTK9bUXQLCQ_3(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_36), ((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_37));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		T5_ = (void*)0;
		T5_ = sslSymThrows__dsinlRPqANpoUTK9bUXQLCQ_2(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_38), ((NimStringDesc*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSLCTXSetMode__u4DGuCXu9asDo9aQgd9cu5QNQ)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ctx, NI mode) {
	...
	result = (NI)0;
	T1_ = (long)0;
	T1_ = Dl_18940414_(ctx, ((int) 33), ((long) (mode)), NIM_NIL);
	result = ((NI) (T1_));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, SSL_set_tlsext_host_name__jGR2GiKRQZ9cgDkYFu4P9aNg)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ssl, NCSTRING name) {
	NI result;
	result = (NI)0;
	result = Dl_18940443_(ssl, ((int) 55), ((NI) 0), ((void*) (name)));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, stdlib_opensslInit000)(void) {
{
	...
	void* T100002_;
	T100001_ = (void*)0;
	T100001_ = sslSymNullable__dsinlRPqANpoUTK9bUXQLCQ(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_49), ((NimStringDesc*) NIM_NIL));
	theProc__4YwZzkNFGan9bZ7C2TUrksA = ((tyProc__Vff1ipOwDPDGknaRJAdXjA) (T100001_));
	T100002_ = (void*)0;
	T100002_ = sslSymNullable__dsinlRPqANpoUTK9bUXQLCQ(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_50), ((NimStringDesc*) NIM_NIL));
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_6 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_10)))
	...
	Dl_18930614_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_load_BIO_strings");
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_15 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_21)))
	...
	Dl_18930637_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_new");
	Dl_18931026_ = (tyProc__HBcM2Mt9bfW9bP8CkO25r0mA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_peek_last_error");
	Dl_18931020_ = (tyProc__ILGNrKdZ6rU9bHuzDylmHhA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_error_string");
	Dl_18915661_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "TLSv1_method");
	Dl_18930660_ = (tyProc__2PA7CxitARKs0jpUW1gQ0g) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_set_cipher_list");
	Dl_18940414_ = (tyProc__J5jVzoevP749cPcyUg9cwPEA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_ctrl");
	Dl_18930648_ = (tyProc__H5wL7jexPlRA7WCw9cqLm0A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_set_verify");
	Dl_18930669_ = (tyProc__tYatIIo0oRSB9bjHLep7yhQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_use_certificate_chain_file");
	Dl_18930673_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_use_PrivateKey_file");
	Dl_18930678_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_check_private_key");
	Dl_18940622_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_clear_error");
	Dl_18930701_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_shutdown");
	Dl_18930724_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_get_error");
	Dl_18930619_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_free");
	Dl_18930616_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_new");
	Dl_18930697_ = (tyProc__EJ9cbYwLVOng2t4wnewGkmA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_set_fd");
	Dl_18940443_ = (tyProc__xGcw2zK9bzuUE9c8WzKW5hzw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_ctrl");
	Dl_18930711_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_connect");
	Dl_18930728_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_accept");
	Dl_18930719_ = (tyProc__sG7rgqmtlgBaumPwwN3BfQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_write");
	Dl_18930731_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_pending");
	Dl_18930714_ = (tyProc__09aW01hZ1tSPafLaWVpBcXA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_read");
}
