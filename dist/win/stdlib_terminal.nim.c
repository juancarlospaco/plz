...
extern tyProc__zP2zGemcuVRvOUE82f9a0Pw Dl_12826820_;
static void* TM__CN3raB9atujkEiPpxYAdlgQ_4;
tyProc__oew1DfaGl5XhHmnBK0HYXQ Dl_15451308_;
tyProc__uryidYWkntM7ddjZSyxvyQ Dl_15451318_;
tyProc__vjGHiWUJwFzOgSxDffBb6Q Dl_15451320_;
tyProc__oPCjp4xTgEl9a8fqSzOv8lw Dl_15470034_;
...
N_LIB_PRIVATE N_NIMCALL(void, initTerminal__pedJmwzZhBZ3Plges9cE1og)(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* term) {
	NI hStdoutTemp;
	NI hStderrTemp;
	hStdoutTemp = Dl_12826820_(((NI32) -11));
	{
		NI T3_;
		NI T4_;
		NI T5_;
		...
		T5_ = Dl_15451318_();
		T6_ = (NI32)0;
		T6_ = Dl_15451308_(T4_, hStdoutTemp, T5_, (&(*term).hStdout), ((NI32) 0), ((NI32) 1), ((NI32) 2));
		if (!(T6_ == ((NI32) 0))) goto LA7_;
	}
	LA7_: ;
	hStderrTemp = Dl_12826820_(((NI32) -12));
	{
		NI T11_;
		NI T12_;
		NI T13_;
		...
		T13_ = Dl_15451318_();
		T14_ = (NI32)0;
		T14_ = Dl_15451308_(T12_, hStderrTemp, T13_, (&(*term).hStderr), ((NI32) 0), ((NI32) 1), ((NI32) 2));
...
N_LIB_PRIVATE N_NIMCALL(void, resetAttributes__6J8xlU57R8cS9bLzTS89aM5g)(FILE* f) {
	...
	term = getTerminal__eaf5C0KoL9blsRnH3dpKg9cAterminal();
	{
		...
		if (!(f == stderr)) goto LA3_;
		T5_ = (NI32)0;
		T5_ = Dl_15470034_((*term).hStderr, (*term).oldStderrAttr);
		(void)(T5_);
	}
	goto LA1_;
	LA3_: ;
	{
		NI32 T7_;
		T7_ = (NI32)0;
		T7_ = Dl_15470034_((*term).hStdout, (*term).oldStdoutAttr);
		(void)(T7_);
	}
	LA1_: ;
}
...
if (!((TM__CN3raB9atujkEiPpxYAdlgQ_4 = nimLoadLibrary(((NimStringDesc*) &TM__CN3raB9atujkEiPpxYAdlgQ_6)))
	...
	Dl_15451308_ = (tyProc__oew1DfaGl5XhHmnBK0HYXQ) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "DuplicateHandle");
	Dl_15451318_ = (tyProc__uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "GetCurrentProcess");
	Dl_15451320_ = (tyProc__vjGHiWUJwFzOgSxDffBb6Q) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "GetConsoleScreenBufferInfo");
	Dl_15470034_ = (tyProc__oPCjp4xTgEl9a8fqSzOv8lw) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "SetConsoleTextAttribute");
}
