...
extern tyProc__zKRRdAZhB37HYjlJgTxZRg Dl_12797867_;
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	o = newWideCString__rFkWhJjmVi0m0Hc9agVEZIQ(((NimStringDesc*) &TM__CZNeKGdQ8AWxD1HSDIq5DQ_3));
	T1_ = (NimStringDesc*)0;
	T1_ = prepare__w0beoDPQKB8sTRhzxkmwzw(url);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	u = newWideCString__rFkWhJjmVi0m0Hc9agVEZIQ(T1_);
	T2_ = (NI)0;
	T2_ = Dl_12797867_(((NI) 0), o, u, NIM_NIL, NIM_NIL, ((NI32) 1));
	(void)(T2_);
	}BeforeRet_: ;
}
