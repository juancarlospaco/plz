...
extern tyProc__LGDJfXC77WFm4ami8tbVyg Dl_12827022_;
extern tyProc__9cfAa2qMwRsugQ9bZaJfhIcQ Dl_12827640_;
extern tyProc__aO673xGTLLxou7P7GxoCXA Dl_12826835_;
extern tyProc__im9buRnIvptJfzdASYMEbBA Dl_12827001_;
extern tyProc__9bXer9a4ps9aSGctILcxWReVw Dl_12826830_;
extern NIM_BOOL nimInErrorMode__759bT87luu8XGcbkw13FUjA;
extern tyProc__2Dt6vzy4xOVEtn3qjtrTDQ Dl_12827624_;
extern tyProc__dQrdVesp1gLEVufnwKAlGA Dl_12827650_;
extern tyProc__dQrdVesp1gLEVufnwKAlGA Dl_12827645_;
extern tyProc__2Dt6vzy4xOVEtn3qjtrTDQ Dl_12827647_;
extern tyProc__KHeEdNTR0xu6nVKzb2dFPw Dl_12827018_;
extern tyProc__lLim4ugM6CVjiaTaa7eXVA Dl_12827456_;
extern tyProc__ofoySXaAAlxxs9bQS9a1etlg Dl_12827614_;
extern tyProc__upTK7viB3ItEbrKv1N4qcg Dl_12827004_;
extern tyProc__2Dt6vzy4xOVEtn3qjtrTDQ Dl_12828597_;
extern tyProc__HH5OcpN6GzcD9cRu6eeMBGw Dl_12827627_;
extern tyProc__OOyWBIidJm2ts1p9ci5TMxQ Dl_12827011_;
static void* TM__yu6cxgKBBXbNsTkT9cyMd4g_19;
tyProc__9bXer9a4ps9aSGctILcxWReVw Dl_15095201_;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	...
	buf = newWideCString__K8rR70TBwrP6FNBzDhVVOA("", ((NI) (bufsize)));
	{
		while (1) {
			NI32 L;
			L = Dl_12827022_(((NI) 0), buf, bufsize);
			{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, osErrorMsg__33xViSVWAmDrexoKkLfMhg)(NI32 errorCode) {
	...
	result = ((NimStringDesc*) NIM_NIL);
	{
		...
		msgbuf = (NI16*)0;
		{
			NI32 T7_;
			T7_ = (NI32)0;
			T7_ = Dl_12826835_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			result = dollar___NleKxkskBzDhxdrvP1WL7A(msgbuf);
			{
				if (!!((msgbuf == NIM_NIL))) goto LA12_;
				Dl_12827001_(((void*) (msgbuf)));
			}
			LA12_: ;
		}
		LA8_: ;
...
if (!((TM__yu6cxgKBBXbNsTkT9cyMd4g_19 = nimLoadLibrary(((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_21)))
	...
	Dl_15095201_ = (tyProc__9bXer9a4ps9aSGctILcxWReVw) nimGetProcAddr(TM__yu6cxgKBBXbNsTkT9cyMd4g_19, "GetCurrentProcessId");
}
