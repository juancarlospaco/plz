...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19035614_;
static void* TM__SLGpYVEqpFQ7VaPsJH6HIA_43;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_19035637_;
tyProc__wCuLyuC5VitcgJKGCqJQRw Dl_19036026_;
tyProc__5zMKCPIiPHTYY9cjyzsHlmQ Dl_19036020_;
tyProc__HXibadfWHwHwyhCwpIRD2A Dl_19021252_;
tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_19035660_;
...
tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_19045414_;
tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_19035648_;
tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_19035669_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_19035673_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19035678_;
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19045632_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19035701_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_19035724_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_19035619_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_19035616_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_19035697_;
tyProc__xGcw2zK9bzuUE9c8WzKW5hzw Dl_19045443_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19035711_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19035728_;
tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_19035719_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19035731_;
tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_19035714_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSLCTXSetMode__u4DGuCXu9asDo9aQgd9cu5QNQ)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ctx, NI mode) {
	NI result;
	result = (NI)0;
	result = Dl_19045414_(ctx, ((int) 33), mode, NIM_NIL);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, SSL_set_tlsext_host_name__jGR2GiKRQZ9cgDkYFu4P9aNg)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ssl, NCSTRING name) {
	NI result;
	result = (NI)0;
	result = Dl_19045443_(ssl, ((int) 55), ((NI) 0), ((void*) (name)));
	return result;
}
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_6 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_38)))
	...
	Dl_19035614_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_load_BIO_strings");
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_75)))
	...
	Dl_19035637_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_new");
	Dl_19036026_ = (tyProc__wCuLyuC5VitcgJKGCqJQRw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_peek_last_error");
	Dl_19036020_ = (tyProc__5zMKCPIiPHTYY9cjyzsHlmQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_error_string");
	Dl_19021252_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "TLSv1_method");
	Dl_19035660_ = (tyProc__2PA7CxitARKs0jpUW1gQ0g) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_set_cipher_list");
	Dl_19045414_ = (tyProc__JfY9aCDiBh9bgOEieo8Vltxg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_ctrl");
	Dl_19035648_ = (tyProc__H5wL7jexPlRA7WCw9cqLm0A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_set_verify");
	Dl_19035669_ = (tyProc__tYatIIo0oRSB9bjHLep7yhQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_use_certificate_chain_file");
	Dl_19035673_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_use_PrivateKey_file");
	Dl_19035678_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_check_private_key");
	Dl_19045632_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_clear_error");
	Dl_19035701_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_shutdown");
	Dl_19035724_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_get_error");
	Dl_19035619_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_free");
	Dl_19035616_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_new");
	Dl_19035697_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_set_fd");
	Dl_19045443_ = (tyProc__xGcw2zK9bzuUE9c8WzKW5hzw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_ctrl");
	Dl_19035711_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_connect");
	Dl_19035728_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_accept");
	Dl_19035719_ = (tyProc__sG7rgqmtlgBaumPwwN3BfQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_write");
	Dl_19035731_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_pending");
	Dl_19035714_ = (tyProc__09aW01hZ1tSPafLaWVpBcXA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_read");
}
