...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA32_;
	{
		...
		T37_[2] = nsuJoinSep(args, argsLen_0, ((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_12));
		echoBinSafe(T37_, 3);
	}
	LA35_: ;
	(*result).id = pid;
	...
	{
		if (!((options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0)) goto LA40_;
		(*result).inHandle = ((int) 0);
		(*result).outHandle = ((int) 1);
		{
			if (!((options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA44_;
	...
	LA40_: ;
	{
		...
		{
			int T52_;
			if (!((options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA50_;
			(*result).errHandle = (*result).outHandle;
			T52_ = (int)0;
			T52_ = close(pStderr[(((NI) 0))- 0]);
			(void)(T52_);
		}
		goto LA48_;
		LA50_: ;
		...
		LA48_: ;
		T54_ = (int)0;
		T54_ = close(pStderr[(((NI) 1))- 0]);
		(void)(T54_);
		T55_ = (int)0;
		T55_ = close(pStdin[(((NI) 0))- 0]);
		(void)(T55_);
		T56_ = (int)0;
		T56_ = close(pStdout[(((NI) 1))- 0]);
		(void)(T56_);
	}
	LA38_: ;
	{
...
{nimErr_ = nimErrorFlag();
	{
		if (!!((((*p).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0))) goto LA3_;
		{
			...
			close__y1KA3B0U09bKtU09am9a9avRYQ_4((*p).inStream);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA5_;
		LA7_: ;
		...
		LA5_: ;
		{
			...
			close__y1KA3B0U09bKtU09am9a9avRYQ_4((*p).outStream);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA11_;
		LA13_: ;
		...
		LA11_: ;
		{
			...
			close__y1KA3B0U09bKtU09am9a9avRYQ_4((*p).errStream);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA17_;
		LA19_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	close__y1KA3B0U09bKtU09am9a9avRYQ_4(T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
