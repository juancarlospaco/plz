...
extern tyProc__As5z9bYt859cLKWaorPRgQYA Dl_12828465_;
extern NIM_BOOL nimInErrorMode__759bT87luu8XGcbkw13FUjA;
extern tyProc__9aO2cP4IgwjXF8JfUR57CHQ Dl_12828283_;
extern tyProc__IQbFr9cLT9bipWCXYfwYwjOw Dl_12828288_;
extern tyProc__MvjKU9c5nvs0N3IrS4vNgSw Dl_12828470_;
extern tyProc__rWrG4X5lbcXQyLNkF9aNWhQ Dl_12828359_;
...
{	result = (NI)0;
	sockType_2 = sockType;
	result = Dl_12828283_(domain, sockType_2, protocol);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
{nimErr_ = nimErrorFlag();
	...
	LA5_: ;
	gaiResult = Dl_12828470_(nimToCStringConv(address), nimToCStringConv(socketPort), (&hints), &result);
	{
		NI32 T14_;
...
N_LIB_PRIVATE N_NIMCALL(NI, selectRead__9bIaBs2UCYYCy7M7lbU4JZA)(tySequence__qwqHTkRvwhrRyENtudHQ7g** readfds, NI timeout) {
	...
	createFdSet__RJdBj9bWg47H8mVaVGsGm9cA((&rd), (*readfds), (&m));
	{
		...
		if (!!((timeout == ((NI) -1)))) goto LA3_;
		T5_ = (int)0;
		T5_ = Dl_12828359_(((int) ((NI)(m + ((NI) 1)))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (T5_));
	}
	goto LA1_;
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_12828359_(((int) ((NI)(m + ((NI) 1)))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (T7_));
	}
	LA1_: ;
...
nimErr_ = nimErrorFlag();
	osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w = INVALID_SOCKET;
	{
		...
		NI32 T6_;
		T3_ = (int)0;
		T3_ = Dl_12828465_(((NI16) 257), (&wsa__ClAT9bhT9cqG9adztamb5X9b2w));
