...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_6, "rbe", 3);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_7, "wbe", 3);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_8, "w+be", 4);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9, "r+be", 4);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_10, "abe", 3);
...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_12, "cannot set file position", 24);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_13, "cannot retrieve file position", 29);
...
{nimErr_ = nimErrorFlag();
	{
		...
		T4_ = (NI)0;
		T4_ = writeBuffer__Y9atVWUcVyKHG9aBP4D0P9czA(f, T3_, ((NI) ((s ? s->Sup.len : 0))));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	result = ftello(f);
	{
		...
		raiseEIO__ZYk14k3sVNZUIjJjtqzFZQ(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_13));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	}BeforeRet_: ;
...
appendString(T11_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_11));
...
static TNimNode* TM__MnCJ0VAmeZ9aTATUB39cx60Q_14_5[5];
NI TM__MnCJ0VAmeZ9aTATUB39cx60Q_16;
static char* NIM_CONST TM__MnCJ0VAmeZ9aTATUB39cx60Q_15[5] = {
"fmRead", 
"fmWrite", 
"fmReadWrite", 
"fmReadWriteExisting", 
...
for (TM__MnCJ0VAmeZ9aTATUB39cx60Q_16 = 0; TM__MnCJ0VAmeZ9aTATUB39cx60Q_16 < 5; TM__MnCJ0VAmeZ9aTATUB39cx60Q_16++) {
TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[TM__MnCJ0VAmeZ9aTATUB39cx60Q_16+1].kind = 1;
TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[TM__MnCJ0VAmeZ9aTATUB39cx60Q_16+1].offset = TM__MnCJ0VAmeZ9aTATUB39cx60Q_16;
TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[TM__MnCJ0VAmeZ9aTATUB39cx60Q_16+1].name = TM__MnCJ0VAmeZ9aTATUB39cx60Q_15[TM__MnCJ0VAmeZ9aTATUB39cx60Q_16];
TM__MnCJ0VAmeZ9aTATUB39cx60Q_14_5[TM__MnCJ0VAmeZ9aTATUB39cx60Q_16] = &TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[TM__MnCJ0VAmeZ9aTATUB39cx60Q_16+1];
}
TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[6].len = 5; TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[6].kind = 2; TM__MnCJ0VAmeZ9aTATUB39cx60Q_0[6].sons = &TM__MnCJ0VAmeZ9aTATUB39cx60Q_14_5[0];
