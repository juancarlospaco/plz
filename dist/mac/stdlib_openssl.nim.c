...
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_45, "libssl.1.1.dylib", 16);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_47, "libssl.38.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_49, "libssl.39.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_51, "libssl.41.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_53, "libssl.43.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_55, "libssl.44.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_57, "libssl.45.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_59, "libssl.46.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_61, "libssl.47.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_63, "libssl.10.dylib", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_65, "libssl.1.0.2.dylib", 18);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_67, "libssl.1.0.1.dylib", 18);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_69, "libssl.1.0.0.dylib", 18);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_71, "libssl.0.9.9.dylib", 18);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_73, "libssl.0.9.8.dylib", 18);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_75, "libssl.dylib", 12);
extern TNimType NTI__HV2B9a6TW6WPpQna2mQFeQQ_;
extern TNimType NTI__x1muge9crz9aAVqWWUrEL9aXg_;
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_78, "Could not load ", 15);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_79, " nor ", 5);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_80, "SSLv23_method", 13);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_81, "TLS_method", 10);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_90, "OpenSSL_version_num", 19);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_91, "SSLeay", 6);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_92, "SSL_CTX_set_ciphersuites", 24);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_103, "SSL_in_init", 11);
STRING_LITERAL(TM__SLGpYVEqpFQ7VaPsJH6HIA_104, "SSL_state", 9);
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19080614_;
static void* TM__SLGpYVEqpFQ7VaPsJH6HIA_43;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_19080637_;
tyProc__wCuLyuC5VitcgJKGCqJQRw Dl_19081026_;
tyProc__5zMKCPIiPHTYY9cjyzsHlmQ Dl_19081020_;
tyProc__HXibadfWHwHwyhCwpIRD2A Dl_19066248_;
tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_19080660_;
...
tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_19090414_;
tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_19080648_;
tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_19080669_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_19080673_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080678_;
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19090622_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080701_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_19080724_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_19080619_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_19080616_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_19080697_;
tyProc__xGcw2zK9bzuUE9c8WzKW5hzw Dl_19090443_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080711_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080728_;
tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_19080719_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_19080731_;
tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_19080714_;
...
appendString(T6_, ((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_78));
appendString(T6_, method1);
appendString(T6_, ((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_79));
...
{nimErr_ = nimErrorFlag();
	result = (tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw*)0;
	result = loadPSSLMethod__Ly1cbhDPrPcypgHb7sj70w(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_80), ((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_81));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = (void*)0;
	T1_ = utilSymNullable__dsinlRPqANpoUTK9bUXQLCQ_3(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_90), ((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_91));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		T5_ = (void*)0;
		T5_ = sslSymThrows__dsinlRPqANpoUTK9bUXQLCQ_2(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_92), ((NimStringDesc*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSLCTXSetMode__u4DGuCXu9asDo9aQgd9cu5QNQ)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ctx, NI mode) {
	NI result;
	result = (NI)0;
	result = Dl_19090414_(ctx, ((int) 33), mode, NIM_NIL);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, SSL_set_tlsext_host_name__jGR2GiKRQZ9cgDkYFu4P9aNg)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ssl, NCSTRING name) {
	NI result;
	result = (NI)0;
	result = Dl_19090443_(ssl, ((int) 55), ((NI) 0), ((void*) (name)));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, stdlib_opensslInit000)(void) {
{
	...
	void* T100002_;
	T100001_ = (void*)0;
	T100001_ = sslSymNullable__dsinlRPqANpoUTK9bUXQLCQ(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_103), ((NimStringDesc*) NIM_NIL));
	theProc__4YwZzkNFGan9bZ7C2TUrksA = ((tyProc__Vff1ipOwDPDGknaRJAdXjA) (T100001_));
	T100002_ = (void*)0;
	T100002_ = sslSymNullable__dsinlRPqANpoUTK9bUXQLCQ(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_104), ((NimStringDesc*) NIM_NIL));
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_6 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_38)))
	...
	Dl_19080614_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_load_BIO_strings");
if (!((TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_45)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_47)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_49)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_51)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_53)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_55)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_57)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_59)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_61)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_63)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_65)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_67)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_69)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_71)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_73)))
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_43 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_75)))
)) nimLoadLibraryError(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_2));
	Dl_19080637_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_new");
	Dl_19081026_ = (tyProc__wCuLyuC5VitcgJKGCqJQRw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_peek_last_error");
	Dl_19081020_ = (tyProc__5zMKCPIiPHTYY9cjyzsHlmQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_error_string");
	Dl_19066248_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "TLSv1_method");
	Dl_19080660_ = (tyProc__2PA7CxitARKs0jpUW1gQ0g) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_set_cipher_list");
	Dl_19090414_ = (tyProc__JfY9aCDiBh9bgOEieo8Vltxg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_ctrl");
	Dl_19080648_ = (tyProc__H5wL7jexPlRA7WCw9cqLm0A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_set_verify");
	Dl_19080669_ = (tyProc__tYatIIo0oRSB9bjHLep7yhQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_use_certificate_chain_file");
	Dl_19080673_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_use_PrivateKey_file");
	Dl_19080678_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_CTX_check_private_key");
	Dl_19090622_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_clear_error");
	Dl_19080701_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_shutdown");
	Dl_19080724_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_get_error");
	Dl_19080619_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_free");
	Dl_19080616_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_new");
	Dl_19080697_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_set_fd");
	Dl_19090443_ = (tyProc__xGcw2zK9bzuUE9c8WzKW5hzw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_ctrl");
	Dl_19080711_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_connect");
	Dl_19080728_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_accept");
	Dl_19080719_ = (tyProc__sG7rgqmtlgBaumPwwN3BfQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_write");
	Dl_19080731_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_pending");
	Dl_19080714_ = (tyProc__09aW01hZ1tSPafLaWVpBcXA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_43, "SSL_read");
}
