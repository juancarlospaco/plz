...
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_17, "Couldn\'t select SIGPIPE", 23);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_18, "TLS/SSL connection failed to initiate, socket closed prematurel"
"y.", 65);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_19, "Not enough data on socket.", 26);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_20, "Function for x509 lookup has been called.", 41);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_21, "IO error has occurred ", 22);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_22, "because an EOF was observed that violates the protocol", 54);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_23, "in the BIO layer", 16);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_24, ": ", 2);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_25, "Unknown Error", 13);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_26, "No valid socket error code available", 36);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_27, "Couldn\'t unblock SIGPIPE", 24);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_28, "Couldn\'t resolve address: ", 26);
...
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_38, "Invalid IP Address. The address consists of too few groups", 58);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_39, "Could not send all data.", 24);
N_LIB_PRIVATE TNimType NTI__VuFrIFILhVuaGaO5FCG0Og_;
N_LIB_PRIVATE TNimType NTI__OhBa09cfBAnY4MdnNlGabWQ_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_40, "Call to \'", 9);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_41, "\' timed out.", 12);
extern TNimType NTI__9apztJSmgERYU8fZOjI4pOg_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_42, "readLine", 8);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_43, "\015\012", 2);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_44, "recv", 4);

/* section: NIM_merge_VARS */
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_18980614_;
extern NIM_BOOL nimInErrorMode__759bT87luu8XGcbkw13FUjA;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_18980637_;
extern tyProc__wCuLyuC5VitcgJKGCqJQRw Dl_18981026_;
extern tyProc__5zMKCPIiPHTYY9cjyzsHlmQ Dl_18981020_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_18966248_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_18980660_;
extern tyProc__JfY9aCDiBh9bgOEieo8Vltxg Dl_19025459_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_18980648_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_18980669_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_18980673_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18980678_;
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_19025667_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18980701_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_18980724_;
extern tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_18980619_;
extern int osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_18980616_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_18980697_;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18980711_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18980728_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_18980719_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18980731_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_18980714_;
...
{nimErr_ = nimErrorFlag();
	result = (int)0;
	{
		...
		if (!T3_) goto LA7_;
		T9_ = (long)0;
		T9_ = Dl_19025459_(ctx, ((int) 94), ((long) (onoff)), NIM_NIL);
		result = ((int) (T9_));
	}
	goto LA1_;
	LA7_: ;
...
appendString(T18_, keyFile);
	...
	LA15_: ;
	{
		...
		ret = Dl_18980669_(ctx, nimToCStringConv(certFile));
		{
	...
	LA21_: ;
	{
		if (!!(((keyFile ? keyFile->Sup.len : 0) == 0))) goto LA29_;
		{
			int T33_;
			T33_ = (int)0;
			T33_ = Dl_18980673_(ctx, nimToCStringConv(keyFile), ((int) 1));
...
{nimErr_ = nimErrorFlag();
	...
	}
	{
		int T9_;
		T9_ = (int)0;
		T9_ = Dl_18980660_(newCTX, nimToCStringConv(cipherList));
	...
	LA26_: ;
	Dl_18980648_(newCTX, ((NI) 0), NIM_NIL);
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(result, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_26));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA7_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	{
		if (!(*socket).isSsl) goto LA3_;
		{
			...
			ret = Dl_18980724_((*socket).sslHandle, ((int) (err)));
			switch (ret) {
			case ((NI) 6):
			{
			...
			case ((NI) 4):
			{
				raiseSSLError__4bk00w9al9cfmeFR9a9cMW860g(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_20));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			break;
			case ((NI) 5):
			{
				...
				osErr = osLastError__9bUWNxbcGnToMWA9b79aTXLIw();
				{
					...
					if (!!(T26_)) goto LA27_;
					errStr = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_21));
					sslErr = Dl_18981026_();
					{
						NIM_BOOL T31_;
						T31_ = (NIM_BOOL)0;
...
appendString(errStr, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_23));
					}
					goto LA29_;
					LA38_: ;
					{
						...
						NimStringDesc* T42_;
						T41_ = (NCSTRING)0;
						T41_ = Dl_18981020_(sslErr, NIM_NIL);
...
appendString(T42_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_24));
appendString(T42_, errStr_2);
			...
			default:
			{
				raiseSSLError__4bk00w9al9cfmeFR9a9cMW860g(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_25));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			break;
			}
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (!T4_) goto LA6_;
		{
			...
			Dl_19025667_();
			res = Dl_18980701_((*socket).sslHandle);
			{
			...
			LA43_: ;
			{
				...
				sslError = Dl_18980724_((*socket).sslHandle, res);
				{
					NIM_BOOL T50_;
					T50_ = (NIM_BOOL)0;
					...
					if (!T50_) goto LA52_;
					{
						if (!(err == ((NI32) 32))) goto LA56_;
						{
							...
							errX60gensym102X60gensym105_ = sigwait((&watchSetX60gensym102_), (&signalX60gensym102X60gensym105_));
							{
								...
								raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(errX60gensym102X60gensym105_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_17));
			...
			}
			{
				oldNimErrFin40_ = *nimErr_; *nimErr_ = NIM_FALSE;
				{
					if (!!(alreadyBlockedX60gensym102_)) goto LA76_;
					{
						...
						raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T83_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_27));
						if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					}
					LA81_: ;
				}
...
appendString(T69_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_28));
...
{nimErr_ = nimErrorFlag();
	...
	(*socket).sslHandle = Dl_18980616_((*(*socket).sslContext).context);
	...
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_18980697_((*socket).sslHandle, (*socket).fd);
...
{	nimZeroMem((void*)(&result), sizeof(tyObject_IpAddress__t0yd6ha54oWXm7nwZ4QqfA));
			...
			while (1) {
				...
				c = addressStr->data[i_2];
				{
					...
					LA30_: ;
					{
						if (!(i == ((NI) 0))) goto LA42_;
						{
							...
							(*T48_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_34));
					...
					{
						{
							...
							(*T54_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_35));
				...
				LA56_: ;
				{
					...
					LA70_: ;
					{
						...
						(*T84_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_36));
				...
				LA68_: ;
				{
					...
					(*T86_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_37));
	...
	} LA6: ;
	{
		if (!(v4StartPos == ((NI) -1))) goto LA89_;
		{
			if (!separatorValid) goto LA93_;
			{
				...
				(*T99_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
	...
	LA89_: ;
	{
				...
				while (1) {
					...
					c_2 = colontmp_->data[i_4];
					{
						...
						currentShort = (NU32)((NU32)((NU32)((NU32)(currentShort) * (NU32)(((NU32) 10)))) + (NU32)(((NU32) ((NI)(((NU8)(c_2)) - ((NI) 48))))));
						{
							...
							(*T114_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_36));
					...
					LA108_: ;
					{
						if (!((NU8)(c_2) == (NU8)(46))) goto LA116_;
						{
							...
							(*T124_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_30));
					...
					LA116_: ;
					{
						...
						(*T126_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_37));
		...
		}
		{
			...
			(*T133_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_30));
	...
	LA87_: ;
	{
		...
		(*T138_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
	...
	LA136_: ;
	{
		...
		if (!(groupCount < ((NI) 8))) goto LA140_;
		{
			...
			(*T146_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_38));
	...
	LA140_: ;
	{
		...
		(*T156_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
			...
			while (1) {
				...
				i = res;
				{
					...
					currentByte = (NU16)((NU16)((NU16)((NU16)(currentByte) * (NU16)(((NU16) 10)))) + (NU16)(((NU16) ((NI)(((NU8)(addressStr->data[i])) - ((NI) 48))))));
					{
						...
						(*T12_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_36));
				...
				LA14_: ;
				{
					...
					(*T24_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_37));
...
{nimErr_ = nimErrorFlag();
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 0):
	{
		...
		LA7_: ;
		Dl_19025667_();
		ret = Dl_18980711_((*socket).sslHandle);
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 1):
	{
		int ret_2;
		Dl_19025667_();
		ret_2 = Dl_18980728_((*socket).sslHandle);
...
{	result = (NI)0;
	{
		...
		Dl_19025667_();
		T5_ = (int)0;
		T5_ = Dl_18980719_((*socket).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T10_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_39));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA8_: ;
	}BeforeRet_: ;
...
appendString(T24_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_41));
		...
		LA21_: ;
		{
			...
			LA32_: ;
			sslPending = Dl_18980731_((*socket).sslHandle);
			{
...
appendString(T49_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_41));
...
{	result = (NI)0;
	result = ((NI) 0);
	{
		...
		Dl_19025667_();
		T5_ = (int)0;
		T5_ = Dl_18980714_((*socket).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	...
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = (NIM_CHAR)0;
			T3_ = (NI)0;
			T3_ = waitFor__mpNV4IG56MRYASsne34FNA(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_42));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			(void)(T3_);
			...
			LA4_: ;
			{
				...
				T20_ = (NI)0;
				T20_ = waitFor__mpNV4IG56MRYASsne34FNA(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_42));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				(void)(T20_);
...
appendString((*line), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_43));
				}
				LA38_: ;
				goto BeforeRet_;
			}
...
{nimErr_ = nimErrorFlag();
	...
	read = ((NI) 0);
	{
		while (1) {
			...
			avail = waitFor__mpNV4IG56MRYASsne34FNA(socket, (&waited), timeout, (NI)(size - read), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_44));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			d = ((NCSTRING) (data));
