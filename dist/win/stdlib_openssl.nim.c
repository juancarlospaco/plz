...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_18885614_;
static void* TM__SLGpYVEqpFQ7VaPsJH6HIA_15;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_18885637_;
tyProc__HBcM2Mt9bfW9bP8CkO25r0mA Dl_18886026_;
tyProc__ILGNrKdZ6rU9bHuzDylmHhA Dl_18886020_;
tyProc__HXibadfWHwHwyhCwpIRD2A Dl_18870665_;
tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_18885660_;
...
tyProc__J5jVzoevP749cPcyUg9cwPEA Dl_18895414_;
tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_18885648_;
tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_18885669_;
tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_18885673_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18885678_;
...
tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_18895632_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18885701_;
tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_18885724_;
tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_18885619_;
tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_18885616_;
tyProc__EJ9cbYwLVOng2t4wnewGkmA Dl_18885697_;
tyProc__xGcw2zK9bzuUE9c8WzKW5hzw Dl_18895443_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18885711_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18885728_;
tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_18885719_;
tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_18885731_;
tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_18885714_;
...
N_LIB_PRIVATE N_NIMCALL(NI, SSLCTXSetMode__u4DGuCXu9asDo9aQgd9cu5QNQ)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ctx, NI mode) {
	...
	result = (NI)0;
	T1_ = (long)0;
	T1_ = Dl_18895414_(ctx, ((int) 33), ((long) (mode)), NIM_NIL);
	result = ((NI) (T1_));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, SSL_set_tlsext_host_name__jGR2GiKRQZ9cgDkYFu4P9aNg)(tyObject_SslStruct__hZKic6WnTBMq6Usbg49bnhw* ssl, NCSTRING name) {
	NI result;
	result = (NI)0;
	result = Dl_18895443_(ssl, ((int) 55), ((NI) 0), ((void*) (name)));
	return result;
}
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_6 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_10)))
	...
	Dl_18885614_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_load_BIO_strings");
...
||(TM__SLGpYVEqpFQ7VaPsJH6HIA_15 = nimLoadLibrary(((NimStringDesc*) &TM__SLGpYVEqpFQ7VaPsJH6HIA_21)))
	...
	Dl_18885637_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_new");
	Dl_18886026_ = (tyProc__HBcM2Mt9bfW9bP8CkO25r0mA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_peek_last_error");
	Dl_18886020_ = (tyProc__ILGNrKdZ6rU9bHuzDylmHhA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_error_string");
	Dl_18870665_ = (tyProc__HXibadfWHwHwyhCwpIRD2A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "TLSv1_method");
	Dl_18885660_ = (tyProc__2PA7CxitARKs0jpUW1gQ0g) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_set_cipher_list");
	Dl_18895414_ = (tyProc__J5jVzoevP749cPcyUg9cwPEA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_ctrl");
	Dl_18885648_ = (tyProc__H5wL7jexPlRA7WCw9cqLm0A) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_set_verify");
	Dl_18885669_ = (tyProc__tYatIIo0oRSB9bjHLep7yhQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_use_certificate_chain_file");
	Dl_18885673_ = (tyProc__xjxKRHVZXDqdWXw9bunoZ3w) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_use_PrivateKey_file");
	Dl_18885678_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_CTX_check_private_key");
	Dl_18895632_ = (tyProc__ln4kdL5W9bbX4a1xl8nnVXQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_6, "ERR_clear_error");
	Dl_18885701_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_shutdown");
	Dl_18885724_ = (tyProc__kxUw9cdxJbPtv0iPyoSbDBQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_get_error");
	Dl_18885619_ = (tyProc__e47RoMUolEGMiUlfiZt9abQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_free");
	Dl_18885616_ = (tyProc__Rqjya8uauy9aPcyfGamaSrg) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_new");
	Dl_18885697_ = (tyProc__EJ9cbYwLVOng2t4wnewGkmA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_set_fd");
	Dl_18895443_ = (tyProc__xGcw2zK9bzuUE9c8WzKW5hzw) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_ctrl");
	Dl_18885711_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_connect");
	Dl_18885728_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_accept");
	Dl_18885719_ = (tyProc__sG7rgqmtlgBaumPwwN3BfQ) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_write");
	Dl_18885731_ = (tyProc__Vff1ipOwDPDGknaRJAdXjA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_pending");
	Dl_18885714_ = (tyProc__09aW01hZ1tSPafLaWVpBcXA) nimGetProcAddr(TM__SLGpYVEqpFQ7VaPsJH6HIA_15, "SSL_read");
}
